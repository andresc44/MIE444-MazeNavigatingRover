...
class Avoider():
	...
	#                  	}
Regions_Distances = {
	                     "front_C":  6, "front_L":  -5, "left_R" :  -4,
	                     "left_C" : -3, "left_L" :  -2, "back_R" :  -1,
	                     "back_C" :  0, "back_L" : 1, "right_R": 2,
	                     "right_C":  3, "right_L": 4, "front_R": 5,
	                 	}
...
def __init__(self, vel_obj, obstacle_threshold=0.254, 
				       ...
				       trans_lin_vel=-0.04, trans_ang_vel=1.0): #1.47 rad/s should be 80PWM
		'''
...
def _clearance_test(self):
        ...
        maxima = {"destination": "front_C", "distance": 10e-6}
